...
import {
  ...
  SubmitBtn,
  RegisterRow, RegisterText, RegisterLink,
  RestrictedBadge, RestrictedText,
  Copyright,
  StatusBar, StatusDot, StatusItem, StatusLabel,
} from "./styles";
...
export default function Login() {
  ...
  const [forgotOpen, setForgotOpen]   = useState(false);   // ← controla o modal
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      setUser({ name: userData.name, role: userData.role.toLowerCase(), initials });
      setSuccess(true);
    ...
    <>
      <Wrapper>
        ...
        <Panel>
            ...
            <ShieldOuter>
              ...
              <ShieldSvg viewBox="0 0 24 24" fill="none">
                <path
                  ...
                  fill="#00A3FF22" stroke="#00A3FF" strokeWidth="1.5" strokeLinejoin="round"
                />
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Field>
              <FieldHeader>
                ...
                {/* ← Anchor agora abre o modal em vez de navegar */}
                <Anchor
                  href="#"
            ...
            {apiError && (
              <ErrorMsg style={{
                ...
                marginBottom:'12px', fontSize:'11px', textAlign:'center',
              }}>
                ⚠ {apiError}
              </ErrorMsg>
            )}

            <SubmitBtn type="submit" disabled={loading || success} $loading={loading} $success={success}>
          ...
          <StatusBar>
            <StatusItem>
              <StatusDot /><StatusLabel>SISTEMA OPERACIONAL</StatusLabel>
            </StatusItem>
            <StatusItem>
